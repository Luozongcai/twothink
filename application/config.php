...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '/RPe-2G$U!5gq(soS+b8=*dV<N40`CJlF,KLmnYE', //默认数据加密KEY
	'data_cache_key'=> '/RPe-2G$U!5gq(soS+b8=*dV<N40`CJlF,KLmnYE',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'/RPe-2G$U!5gq(soS+b8=*dV<N40`CJlF,KLmnYE', //加密KEY
