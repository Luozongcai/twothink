<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\www\twothink\public/../application/home/view/default/app\my.html";i:1511937456;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-3">
                <img src="__PUBLIC__/home/home2/image/5.png" width="60" height="60" />
            </div>
            <div class="col-xs-9">
        ...
        <div class="row text-center myLabel">
            ...
            <div class="col-xs-4 label-success"><a href="<?php echo url('myrepairs'); ?>"><span class="iconfont">&#xe609;</span>我的报修</a></div>
            <div class="col-xs-4 label-primary"><a href="<?php echo url('myactivity'); ?>"><span class="iconfont">&#xe606;</span>报名的活动</a></div>
        </div>
        <div class="blank"></div>
        <div>
            <ul class="list-group fuwuList">
                ...
                </li><li class="list-group-item"><a href="<?php echo url('user/login/logout'); ?>" class="text-danger"><span class="iconfont">&#xe60a;</span>退出登录</a>
            </ul>
        </div>
    </div>
</div>
