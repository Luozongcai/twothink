<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\www\twothink\public/../application/home/view/default/app\myrepairs.html";i:1511938490;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="row noticeList">
            <a href="#">
                <div class="col-xs-3">
                    <p class="title text-info ">报修人：<?php echo $channel['username']; ?></p>
                </div>
                <div class="col-xs-6">
