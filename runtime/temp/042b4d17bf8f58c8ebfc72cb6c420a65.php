<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\www\twothink\public/../application/admin/view/default/house\edit.html";i:1512049661;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-title">
	<h2>
		<?php echo !empty($info['id'])?'编辑':'新增'; ?>租售消息
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
	...
	<div class="form-item">
		...
		<div class="controls">
			<input type="text" class="text input-large date" name="start_time"  id="countTimestart" onfocus="selecttime(1)"  size="17" readonly value="<?php echo (isset($info['start_time']) && ($info['start_time'] !== '')?$info['start_time']:''); ?>">
		</div>
	</div>
