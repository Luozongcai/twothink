<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\www\twothink\public/../application/home/view/default/app\zushou.html";i:1512054433;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
        ...
        <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
            ...
            <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                    ...
                    <div class="row">
                        <?php if(is_array($chuzu) || $chuzu instanceof \think\Collection || $chuzu instanceof \think\Paginator): $i = 0; $__LIST__ = $chuzu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
                        <div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                <img src="__PUBLIC__/home/home2/image/tupian/<?=rand(1,8)?>.jpg"  height="200px" alt="...">
                                <div class="caption">
                                    <h4><?php echo $channel['title']; ?></h4>
                                    <p class="zushouInfo">108平套三出租,精装修,拎包入住</p>
                                    <p class="text-danger"><?php echo $channel['price']; ?>.00  <?=$channel['unit']==0?'元/每月':'万元';?></p>
                                    <p><a href="<?php echo url('zuoshouto?id='.$channel['id']); ?>" class="btn btn-danger zushouBtn">详细信息</a> </p>
                                </div>
                            </div>
                        </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                    ...
                    <div class="row">
                        <?php if(is_array($chushou) || $chushou instanceof \think\Collection || $chushou instanceof \think\Paginator): $i = 0; $__LIST__ = $chushou;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
                        <div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                <img src="__PUBLIC__/home/home2/image/tupian/<?=rand(1,8)?>.jpg" height="200px" alt="...">
                                <div class="caption">
                                    <h4><?php echo $channel['title']; ?></h4>
                                    <p class="zushouInfo">精装修,拎包入住</p>
                                    <p class="text-danger">   <?php echo $channel['price']; ?>.00  <?=$channel['unit']==0?'元/每月':'万元';?></p>
                                    <p><a  href="<?php echo url('zuoshouto?id='.$channel['id']); ?>" class="btn btn-danger zushouBtn">详细信息</a> </p>
                                </div>
                            </div>
