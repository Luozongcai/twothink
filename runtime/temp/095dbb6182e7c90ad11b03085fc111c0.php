<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\www\twothink\public/../application/home/view/default/app\renzheng.html";i:1512015097;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <!--导航结束-->
<h2 style="color: #d4343e">欢迎来到业主认证!</h2></br>
    <div class="container-fluid">
        <form action="<?php echo url('app/renzheng'); ?>" method="post" >
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="kith">
                    <option>本人</option>
                    <option>亲属</option>
                    <option>租户</option>
                </select>
