<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\www\twothink\public/../application/home/view/default/app\activity1.html";i:1511964513;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid"  id="content_list">
        ...
        <div class="row noticeList">
            ...
            <div class="col-xs-10">
                <p class="title"><a href="<?php echo url('activityto1?id='.$channel['id']); ?>"><?php echo $channel['title']; ?></a></p>

                <p class="info">商家: <?php echo $channel['username']; ?> &emsp;浏览: <?php echo $channel['click']; ?> &emsp;<span class="pull-right"><?php echo $channel['start_time']; ?></span> </p>
                <p class="info">活动时间:<?php echo $channel['start_time']; ?>至<?php echo $channel['end_time']; ?> </p>
