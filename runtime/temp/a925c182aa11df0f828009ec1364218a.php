<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\www\twothink\public/../application/home/view/default/app\myplot.html";i:1512027753;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="blank"></div>
        <h2 class="noticeDetailTitle"><strong style="color: #ef1939"><?php echo $list['name']; ?></strong></h2>
        <div class="noticeDetailInfo"><span style="color: #7F007F"><h3><?php echo $list['title']; ?></h3></span></div>
