<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\www\twothink\public/../application/home/view/default/index\index.html";i:1512038089;}*/ ?>
    ...
    <div class="container-fluid text-center">
        ...
        <div class="col-xs-3">
          <!--  <p class="navbar-text"><a href="my.html" class="navbar-link">我的</a></p>-->
            <p ><span><span class="pull-left"><span><a href="<?php echo url('User/login/register'); ?>">[立即注册]&emsp;</a></span> </span>
           <span><span class="pull-left"><span> <a href="<?php echo url('User/login/index'); ?>">[点此登录]</a> </span> </span></p>
...
<div class="container-fluid">
    <div class="indexImg row">
        <img src="__PUBLIC__/home/home2/image/index.png" width="100%" />
    </div>
    <div class="serviceList text-center">
        <div class="container">
            <div class="row">
                <div class="col-xs-4">
                    <a href="<?php echo url('app/notice'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('app/service'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('app/repairs'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('app/activity1'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('app/zushou'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('app/activity'); ?>">
...
<script src="__PUBLIC__/home/home2/bootstrap/js/bootstrap.js"></script>
</body>
</html>