<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\www\twothink\public/../application/admin/view/default/repairs\edit.html";i:1511870051;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">问题<span class="check-tips">(请简要说明)</span></label>
			<div class="controls">
		...
		<div class="form-item">
			...
			<div class="controls">
				<textarea  class="textarea  input-large" cols="30" rows="6" name="content"><?php echo (isset($info['content']) && ($info['content'] !== '')?$info['content']:''); ?></textarea>
				<!--<input type="text" class="text input-large" name="title" value="<?php echo (isset($info['title']) && ($info['title'] !== '')?$info['title']:''); ?>">-->
			</div>
		</div>
