<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\www\twothink\public/../application/admin/view/default/house\index.html";i:1512035136;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tr>
            ...
            <td><?=$channel['is_deal']==0?'出租':'出售';?>

            </td>
            <td><?php echo $channel['price']; ?>.00  <?=$channel['unit']==0?'元/每月':'万元';?></td>
            <td><?php echo $channel['start_time']; ?></td>
            <td><?php echo $channel['end_time']; ?></td>
            <td><?php  $arr=[0=>'待发布',1=>'启用',2=>'禁用',3=>'已过期']; echo $arr[$channel['status']]; ?></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$channel['id'].'&pid='.$pid); ?>">编辑</a>
                <a title="处理" href="<?php echo url('status?id='.$channel['id'].'&pid='.$pid); ?>">
                    <?php  $arr=[0=>'启用',1=>'禁用',2=>'启用',3=>'启用']; echo $arr[$channel['status']]; ?></a>
