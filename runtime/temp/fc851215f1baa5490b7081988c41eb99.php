<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\www\twothink\public/../application/admin/view/default/activity\myedit.html";i:1512027511;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-title">
	<h2>
		<?php echo !empty($info['id'])?'编辑':'新增'; ?>介绍
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
	...
	<div class="form-item">
		<label class="item-label">小区名称<span class="check-tips"></span></label>
		<div class="controls">
			<input type="text" class="text input-large" name="name" value="<?php echo (isset($info['name']) && ($info['name'] !== '')?$info['name']:''); ?>">
		</div>
	</div>
	<div class="form-item">
		<label class="item-label">小区地址<span class="check-tips"></span></label>
		<div class="controls">
...
<!-	<div class="form-item">
		<label class="item-label">小区介绍<span class="check-tips"></span></label>
		<div class="">
