...
<div class="main-title">
	<h2>
		<?php echo !empty($info['id'])?'编辑':'新增'; ?>活动
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
	...
	<div class="form-item">
		<label class="item-label">活动发布方/个人<span class="check-tips"></span></label>
		<div class="controls">
	...
	<div class="form-item">
		<label class="item-label">报名起始时间<span class="check-tips"></span></label>
		<div class="controls">
