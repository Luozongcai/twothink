<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\www\twothink\public/../application/home/view/default/app\activityto1.html";i:1511964513;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="noticeDetailInfo">商家:<span style="color: #7F007F"><?php echo $list['username']; ?></span></div>
        <div class="noticeDetailInfo">活动时间：<?php echo $list['start_time']; ?>至<?php echo $list['end_time']; ?></div>
